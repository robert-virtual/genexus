...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      {
         string cmdBuffer = "";
         /* Indices for table Alumnos */
         try
         {
            cmdBuffer=" CREATE TABLE [Alumnos] ([N_Cuenta] nvarchar(40) NOT NULL , [Nombres] nvarchar(40) NOT NULL , [Apellidos] nvarchar(40) NOT NULL , [Sexo] nvarchar(40) NOT NULL , [Edad] smallint NOT NULL , PRIMARY KEY([N_Cuenta]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[Alumnos]") ;
               cmdBuffer=" DROP TABLE [Alumnos] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[Alumnos]") ;
                     cmdBuffer=" DROP FUNCTION [Alumnos] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("Alumnos",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"Alumnos"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateAlumnos" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Alumnos", ""}) );
      }
