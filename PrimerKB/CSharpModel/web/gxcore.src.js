...
/**@preserve GeneXus 17.0.9.159577*/
		...
		setCtrlPropertyImpl: function (Control, Property, PValue, vStruct) {
			...
			switch (Property) {
				...
				case "SrcSet":
					...
					break;
				case "gximage":
					Control.style.content = (PValue !== '' ? 'var(--GXResource-Image_' + PValue+')' : '');
					break;
				case "Multimedia":
