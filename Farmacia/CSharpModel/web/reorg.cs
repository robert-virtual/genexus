...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTiposProducto( )
      {
         string cmdBuffer = "";
         /* Indices for table TiposProducto */
         try
         {
            cmdBuffer=" CREATE TABLE [TiposProducto] ([tipoid] smallint NOT NULL IDENTITY(1,1), [tipo] nvarchar(40) NOT NULL , PRIMARY KEY([tipoid]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[TiposProducto]") ;
               cmdBuffer=" DROP TABLE [TiposProducto] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               {
                  DropTableConstraints( "[TiposProducto]") ;
                  cmdBuffer=" DROP VIEW [TiposProducto] "
                  ;
                  RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                  RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
                  RGZ.ExecuteStmt() ;
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[TiposProducto]") ;
                     cmdBuffer=" DROP FUNCTION [TiposProducto] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
      ...
      {
         string cmdBuffer = "";
         /* Indices for table Productos */
         try
         {
            cmdBuffer=" CREATE TABLE [Productos] ([productoid] smallint NOT NULL IDENTITY(1,1), [Nombre] nvarchar(40) NOT NULL , [Precio] smallmoney NOT NULL , [Stock] smallint NOT NULL , [tipoid] smallint NOT NULL , PRIMARY KEY([productoid]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[Productos]") ;
               cmdBuffer=" DROP TABLE [Productos] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[Productos]") ;
                     cmdBuffer=" DROP FUNCTION [Productos] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                     RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
                     RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE NONCLUSTERED INDEX [IPRODUCTOS1] ON [Productos] ([tipoid] ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         {
            cmdBuffer=" DROP INDEX [IPRODUCTOS1] ON [Productos] "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void RIProductosTiposProducto( )
      {
         string cmdBuffer;
         try
         {
            cmdBuffer=" ALTER TABLE [Productos] ADD CONSTRAINT [IPRODUCTOS1] FOREIGN KEY ([tipoid]) REFERENCES [TiposProducto] ([tipoid]) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE [Productos] DROP CONSTRAINT [IPRODUCTOS1] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("TiposProducto",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"TiposProducto"}) ) ;
            return false ;
         }
         if ( tableexist("Productos",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"Productos"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateTiposProducto" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateProductos" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "RIProductosTiposProducto" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"TiposProducto", ""}) );
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Productos", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateProductos" ,  "CreateTiposProducto" );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"[IPRODUCTOS1]"}) );
         ReorgExecute.RegisterPrecedence( "RIProductosTiposProducto" ,  "CreateProductos" );
         ReorgExecute.RegisterPrecedence( "RIProductosTiposProducto" ,  "CreateTiposProducto" );
      }
